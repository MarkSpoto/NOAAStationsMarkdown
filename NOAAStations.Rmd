...
### Code used to generate the map
This section is shown for learning purposes.  Below, the code will load the data from the NOAA stations file.  The next section will show how to display the map.
